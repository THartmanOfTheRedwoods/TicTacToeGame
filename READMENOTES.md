...
1. Now, take 15 minutes to get a big picture of the code in this application and its features.
    * Jot down notes here concerning: classes, objects, encapsulation, abstraction, inheritance, and polymorphism (i.e. if they are used, where they occur, etc.).
      ...
      *Classes and objects are obviously present throughout the program. Abstraction is used in the player and its extensions. Computer and sentient inherit from
    * the player class. I don't think I saw any polymorphism, and I am unsure with encapsulation.
...
* 
* I only quickly looked through the code for class computer, so I didn't quite understand what was going on there. Encapsulation and polymorphism are the things I am
* most unfamiliar.
* 
...
1. Let's discuss as a class the items you still have questions about or are unfamiliar with.
    * Take notes here of things that became more clear after the class discussion.
      ...
      * Encapsulation become clearer to me and abstraction became clearer to other teammates.
